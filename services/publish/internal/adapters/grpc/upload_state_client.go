...
func (c *UploadStateClient) UpdateVideoPlayback(ctx context.Context, videoID, hlsMasterPath string) error {
	_, err := c.client.UpdateVideoPlayback(ctx, &upload.UpdateVideoPlaybackRequest{
		VideoId:       videoID,
