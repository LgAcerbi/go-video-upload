...
func (e *extractor) Extract(ctx context.Context, filePath string) (format string, durationSec float64, err error) {
	...
	if probe.Format.Duration != "" {
		...
		if err != nil {
			return format, 0, fmt.Errorf("parse duration: %w", err)
		}
	}
	return format, durationSec, nil
}
